            ...
            <div className="my-20 flex p-5 flex-col items-center space-y-6 max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-white p-6 rounded-2xl border ">
                        <Image src={Home.src} alt="image" width={600} height={500} />
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="bg-white p-6 rounded-2xl border ">
                        <Image src={col1.src} alt="image" width={500} height={500} />
                    ...
                    <div className="bg-white p-6 rounded-2xl border ">
                        <Image src={col2.src} alt="image" width={500} height={500} />
                    ...
                    <div className="bg-white p-6 rounded-2xl border ">
                        <Image src={col3.src} alt="image" width={500} height={500} />
